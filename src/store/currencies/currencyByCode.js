...
const FETCH_CURRENCIES_BY_CURRENCY_CODE__IN_SPECIIC_DATE = 'FETCH_CURRENCIES_BY_CURRENCY_CODE_LATEST_IN_SPECIIC_DATE';
...
export default function currencyRateByCodeReducer(state = {}, action) {
  switch (action.type) {
    ...
    case `${FETCH_CURRENCIES_BY_CURRENCY_CODE__IN_SPECIIC_DATE}/fulfilled`:
      return action.payload;
    default:
      return state;
  }
